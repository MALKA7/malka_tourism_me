...
const DelhiToursPage: React.FC<DelhiToursPageProps> = ({ onPageChange }) => {
  ...
  const delhiPhotos = [
    {
      title: 'המצודה האדומה',
      description: 'מצודה היסטורית מהמאה ה-17 שהייתה מקום מגוריהם של קיסרי המוגול. אתר מורשת עולמית של אונסק"ו עם ארכיטקטורה מרהיבה.',
      image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg'
    },
    {
      title: 'שער הודו',
      description: 'אנדרטה לזכר החיילים ההודים שנפלו במלחמת העולם הראשונה. סמל איקוני של דלהי ומקום מפגש פופולרי.',
      image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg'
    },
    {
      title: 'מסגד ג\'אמה',
      description: 'אחד המסגדים הגדולים בהודו, שנבנה על ידי הקיסר שאה ג\'האן. מקום תפילה פעיל ואתר היסטורי חשוב.',
      image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg'
    },
    {
      title: 'קבר הומיון',
      description: 'קבר הקיסר הומיון, אב הטאג\' מהאל. אתר מורשת עולמית עם גנים פרסיים מרהיבים וארכיטקטורה מוגולית.',
      image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg'
    },
    {
      title: 'קוטב מינאר',
      description: 'מגדל הניצחון הגבוה ביותר בהודו, בן 73 מטר. אתר מורשת עולמית עם חריטות וכתובות עתיקות.',
      image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg'
    },
    {
      title: 'שוק צ\'אנדני צ\'וק',
      description: 'השוק הוותיק והצבעוני ביותר בדלהי, מלא בתכשיטים, בדים, תבלינים ואוכל רחוב מסורתי.',
      image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg'
    },
    {
      title: 'ארמון הנשיא',
      description: 'מעון הנשיא ההודי, בעבר ארמון הווייסרוי הבריטי. מבנה מרשים עם גנים מטופחים.',
      image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg'
    },
    {
      title: 'מקדש לוטוס',
      description: 'מקדש בהאי מודרני בצורת פרח לוטוס. מקום מדיטציה ותפילה פתוח לכל הדתות.',
      image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg'
    },
    {
      title: 'גנים לודי',
      description: 'פארק היסטורי עם קברים עתיקים מתקופת שושלת לודי. מקום מושלם לטיול ולמנוחה.',
      image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg'
    },
    {
      title: 'מוזיאון גנדי',
      description: 'מוזיאון המוקדש למהטמה גנדי, מציג את חייו ופועלו. כולל חפצים אישיים ותמונות נדירות.',
      image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg'
    },
    {
      title: 'אקשרדהם',
      description: 'מקדש הינדי מודרני ומרהיב עם תערוכות אינטראקטיביות על התרבות ההודית.',
      image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg'
    },
    {
      title: 'שוק קרול באג',
      description: 'שוק מודרני ותוסס עם חנויות, מסעדות ובידור. מקום פופולרי לקניות ולבילוי.',
      image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg'
    },
    {
      title: 'מקדש צ\'אטרפור',
      description: 'מקדש הינדי עתיק המוקדש לאל שיווה. מקום עלייה לרגל חשוב ואתר דתי פעיל.',
      image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg'
    },
    {
      title: 'גן החיות הלאומי',
      description: 'גן החיות הוותיק ביותר בהודו עם מגוון רחב של בעלי חיים מקומיים ובינלאומיים.',
      image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg'
    },
    {
      title: 'מוזיאון הרכבת',
      description: 'מוזיאון ייחודי המציג את ההיסטוריה של מערכת הרכבות ההודית עם קטרים עתיקים.',
      image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg'
    },
    {
      title: 'הגנים המוגוליים',
      description: 'גנים היסטוריים בסגנון פרסי עם מזרקות, שבילים מטופחים ונוף יפה.',
      image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg'
    },
    {
      title: 'שוק דריאגנג\'',
      description: 'שוק יבש ותבלינים ארומטי עם מגוון עצום של תבלינים, אגוזים ופירות יבשים.',
      image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg'
    },
    {
      title: 'מקדש הנומן',
      description: 'מקדש המוקדש להנומן, אל הקופים ההינדי. מקום פופולרי לתפילות ולברכות.',
      image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg'
    },
    {
      title: 'פארק נרו',
      description: 'פארק מרכזי גדול עם אגם, גן ורדים ומקומות בילוי למשפחות. לב הירוק של דלהי.',
      image: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg'
    },
    {
      title: 'מוזיאון הלאומי',
      description: 'המוזיאון הגדול ביותר בהודו עם אוספים עשירים של אמנות, ארכיאולוגיה והיסטוריה.',
      image: 'https://images.pexels.com/photos/1007426/pexels-photo-1007426.jpeg'
    }
  ];
