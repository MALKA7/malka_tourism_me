        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="testimonial-text hebrew-text text-gray-700 mb-4 italic">
                "טיול יומי בעברית בבנגלור או מייסור
                טיילנו עם מלכה החודש בהודו, יום טיול בבנגלור ויום טיול מבוקר עד ערב במייסור. זו היתה חוויה יוצאת דופן, מלאת סיפורים והסברים מעניינים על כל המקומות שביקרו בהם."
              </p>
              <div className="testimonial-author hebrew-text font-bold text-gray-900">עמית</div>
              <div className="testimonial-location text-gray-600">ישראל</div>
            </div>
