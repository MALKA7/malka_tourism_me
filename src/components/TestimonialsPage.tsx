  ...
  const writtenTestimonials = [
    {
      ...
      duration: '14 ימים',
      groupSize: '4 אנשים',
      text: 'מלכה הפכה את הטיול שלנו להודו לחוויה בלתי נשכחת! ההדרכה שלה הייתה מקצועית ומרתקת, והיא הראתה לנו את הודו האמיתית. הטיול לקרלה היה מושלם - מהמלונות המעולים ועד לחוויות האותנטיות. מלכה לא רק מדריכה, היא חברה שדואגת לכל פרט. בהחלט נחזור אליה לטיול הבא!',
      externalLink: 'https://www.tripadvisor.com/review1',
