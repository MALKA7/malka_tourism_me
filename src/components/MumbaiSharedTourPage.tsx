...
const OrganizedToursPage: React.FC<OrganizedToursPageProps> = ({ onPageChange }) => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      text: 'מלכה היא מהות ההצדקה לטיול מאורגן, למי שמתלבט אם לנסות להכין טיול בעצמו או לפנות למקצוענית - התשובה ברורה. מלכה מכירה את הודו כמו כף ידה ויודעת בדיוק איך להתאים את הטיול לצרכים שלכם.'
    },
    {
