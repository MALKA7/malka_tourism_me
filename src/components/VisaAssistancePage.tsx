  ...
  const testimonials = [
    {
      ...
      location: 'תל אביב',
      rating: 5,
      text: 'מלכה ארגנה לנו טיול מושלם! הקבוצה שלנו של 12 אנשים נהנתה מכל רגע. ההדרכה בעברית עזרה לנו להבין את התרבות ההודית בעומק.'
    },
    {
                  ...
                  <div className="absolute top-4 right-4 bg-blue-600 text-white px-3 py-2 rounded-lg shadow-lg">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-bold">
                        {vehicle.passengerCount === 20 ? '20+' : vehicle.passengerCount}
                      </span>
                    </div>
                  </div>
                </div>
