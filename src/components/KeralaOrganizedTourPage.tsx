...
import { MapPin, Clock, Users, Star, Phone, Mail, CheckCircle, Calendar, Car, Camera, Trees as Tree, Waves } from 'lucide-react';

interface KeralaOrganizedTourPageProps {
  onPageChange: (page: string) => void;
}

const KeralaOrganizedTourPage: React.FC<KeralaOrganizedTourPageProps> = ({ onPageChange }) => {
  const itinerary = [
    { day: 'יום 1-2', location: 'מומבאי', activities: 'הגעה, סיור בעיר, שער הכניסה להודו, מוזיאון גנדי' },
    ...
    { day: 'יום 14', location: 'חזרה', activities: 'טיסה חזרה דרך קוצ\'י או בנגלור' }
  ];
    ...
    <div className="min-h-screen fade-in">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white max-w-3xl">
            ...
            <p className="text-xl mb-8 leading-relaxed hebrew-text opacity-95">
              ...
              אל קרלה הירוקה והשקטה. 14 ימים של חוויות בלתי נשכחות
            </p>
            <button 
      ...
      <div className="bg-gradient-to-r from-green-500 to-blue-600 text-white py-3 overflow-hidden shadow-md">
        <div className="running-banner whitespace-nowrap">
          <span className="mx-8">הרשמו עכשיו. סיורים עם מדריכה ישראלית המתגוררת בהודו. הוא סיור אנתרופולוגי- הרשמו</span>
          <span className="mx-8">הרשמו עכשיו. סיורים עם מדריכה ישראלית המתגוררת בהודו. הוא סיור אנתרופולוגי- הרשמו</span>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-4 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="breadcrumb">
            ...
            <button onClick={() => onPageChange('organized-tours')} className="breadcrumb-item">סיורים מאורגנים</button>
            <span className="breadcrumb-separator">←</span>
            <span className="text-blue-600 font-bold">טיול מאורגן לקרלה</span>
          </div>
        </div>
      </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 mb-8 border border-gray-200">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-700 hebrew-text">מדריכת הטיול לקרלה</p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-purple-200">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-bold text-purple-600 text-xl">$1,200</span>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 hebrew-text leading-relaxed">
            הצטרפו לטיול המאורגן לקרלה עם מלכה - 
            חוויה בלתי נשכחת של 14 ימים בהודו המופלאה
          </p>
...
export default KeralaOrganizedTourPage;