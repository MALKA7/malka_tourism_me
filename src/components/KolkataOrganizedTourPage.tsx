...
import { MapPin, Clock, Users, Star, Phone, Mail, CheckCircle, Calendar, Car, Camera, Building, Book } from 'lucide-react';

interface KolkataOrganizedTourPageProps {
  onPageChange: (page: string) => void;
}

const KolkataOrganizedTourPage: React.FC<KolkataOrganizedTourPageProps> = ({ onPageChange }) => {
  const itinerary = [
    ...
    { day: 'יום 12', location: 'חזרה', activities: 'טיסה חזרה דרך קולקטה או מומבאי' }
  ];
      ...
      <div className="bg-gray-50 py-4 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="breadcrumb">
            ...
            <span className="breadcrumb-separator">←</span>
            <span className="text-blue-600 font-bold">טיול מאורגן לקולקטה</span>
          </div>
        </div>
      </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 mb-8 border border-gray-200">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-700 hebrew-text">מדריכת הטיול לקולקטה</p>
                ...
                <div className="space-y-4">
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-blue-200">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-bold text-blue-600 text-xl">12 ימים</span>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 hebrew-text leading-relaxed">
            הצטרפו לטיול המאורגן לקולקטה עם מלכה - 
...
export default KolkataOrganizedTourPage;