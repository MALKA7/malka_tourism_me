      ...
      content: (
        <div className="space-y-6">
          <div className="bg-blue-50 p-8 rounded-lg border border-blue-200">
            <h4 className="font-bold text-blue-900 mb-6 hebrew-text text-2xl text-center">יום סיור במומבאי</h4>
            <div className="space-y-4 text-gray-700">
              <div className="flex items-start">
                <span className="font-bold text-blue-600 ml-4 min-w-[80px]">09:45</span>
                <span className="hebrew-text">איסוף המשתתפים</span>
              </div>
              <div className="flex items-start">
                <span className="font-bold text-blue-600 ml-4 min-w-[80px]">10:00</span>
                <span className="hebrew-text">יציאה לתחנת הרכבת</span>
              </div>
              <div className="flex items-start">
                <span className="font-bold text-blue-600 ml-4 min-w-[80px]">10:20</span>
                <span className="hebrew-text">אינטראקציה עם מקומיים בסגנון "המירוץ למיליון"</span>
              </div>
              <div className="flex items-start">
                <span className="font-bold text-blue-600 ml-4 min-w-[80px]">11:00</span>
                <span className="hebrew-text">ביקור אצל שליחי המזון המפורסמים של מומבאי (Dabbawalas)</span>
              </div>
              <div className="flex items-start">
                <span className="font-bold text-blue-600 ml-4 min-w-[80px]">12:15</span>
                <span className="hebrew-text">נסיעה ברכבת המקומית של מומבאי</span>
              </div>
              <div className="flex items-start">
                <span className="font-bold text-blue-600 ml-4 min-w-[80px]">13:00</span>
                <span className="hebrew-text">ביקור במכבסה המקומית (בתוך האתר, לא מהגשר)</span>
              </div>
              <div className="flex items-start">
                <span className="font-bold text-blue-600 ml-4 min-w-[80px]">14:30</span>
                <span className="hebrew-text">ביקור בסלאם הגדול באסיה – אזור מגורים ואזור מסחרי</span>
              </div>
              <div className="flex items-start">
                <span className="font-bold text-blue-600 ml-4 min-w-[80px]">16:00</span>
                <span className="hebrew-text">ביקור בשכונה הזורואסטרית (פרסית)</span>
              </div>
              <div className="flex items-start">
                <span className="font-bold text-blue-600 ml-4 min-w-[80px]">18:00</span>
                <span className="hebrew-text">חזרה לנקודת האיסוף</span>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-red-50 p-6 rounded-lg border border-red-200">
            <h4 className="font-bold text-red-900 mb-4 hebrew-text text-xl">הערות ותנאים חשובים</h4>
            
            <div className="space-y-4 text-gray-700 hebrew-text">
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">מינימום מטיילים</p>
                <p className="text-sm">יציאת הטיול מותנית במינימום של 6 משתתפים.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">שינוי מחיר במקרה של קבוצה קטנה</p>
                <p className="text-sm">במקרה של מספר משתתפים מצומצם מהמינימום, המחיר עלול להשתנות, וכפוף לכך שהמחיר לא יהיה גבוה ביותר מ־25% מהמחיר שפורסם.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">סיור פרטי</p>
                <p className="text-sm">במידה ויש מספר נמוך מהמינימום והבקשה היא לסיור פרטי, תתווסף תוספת מחיר בהתאם.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">החזר במקרה של ביטול בשל חוסר משתתפים</p>
                <p className="text-sm">אם לא יושג מספר המטיילים הנדרש, יוחזר התשלום בניכוי עמלות בנק והעברות, אם יהיו.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">ביטול לאחר כרטיס טיסה</p>
                <p className="text-sm">מרגע שכרטיס הטיסה של מלכה נרכש, לא יינתן החזר כספי – גם לא חלקי, אלא אם נמצא מחליף (בכפוף לעמלות שינוי).</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">ביטוח נסיעות חובה</p>
                <p className="text-sm">על כל משתתף לדאוג לביטוח רפואי וביטוח נסיעות.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">שינויים בלוחות זמנים</p>
                <p className="text-sm">ייתכנו שינויים בשעות או בסדר הביקורים בהתאם לתנאי מזג האוויר, עומסי תנועה או הנחיות מקומיות.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">אחריות כללית</p>
                <p className="text-sm">מלכה אינה אחראית לעיכובים, אובדן ציוד או שירותים הניתנים על ידי ספקים חיצוניים (כגון מסעדות).</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">תשלום סופי</p>
                <p className="text-sm">התשלום המלא יידרש לאחר אישור מקום פנוי, ורק לאחריו תישמר ההרשמה באופן סופי.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">הזמנה אישית לפי דרכון</p>
                <p className="text-sm">כל משתתף חייב להזמין מקום על שמו המדויק כפי שמופיע בדרכון, ללא שינוי בשם לאחר ההרשמה.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">זיהוי במעמד האיסוף</p>
                <p className="text-sm">יש להציג דרכון במעמד איסוף המטיילים ליום הסיור.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">איחור למועד היציאה</p>
                <p className="text-sm">הסיור יוצא בדיוק בזמן בהתאם ללוח הזמנים שנקבע. מטייל המאחר למועד האיסוף יגיע עצמאית למקום המפגש, והסיור לא יעוכב.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">קבוצת וואטסאפ</p>
                <p className="text-sm">תיפתח קבוצת וואטסאפ רשמית של הטיול כשבוע לפני מועד היציאה, לצורך עדכונים, תיאומים ומידע למשתתפים.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">קבלת מידע</p>
                <p className="text-sm">הרשמה לטיול מהווה אישור כי המשתתף קרא והבין את התנאים לעיל.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">מועדי הסיורים</p>
                <p className="text-sm">הסיור מתקיים בימים קבועים, פעמיים בשבוע, ויש לוודא זמינות מראש.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">גודל קבוצה</p>
                <p className="text-sm">מקסימום 12 משתתפים בכל סיור, לחוויה אישית, מעמיקה ואיכותית.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">לבוש הולם</p>
                <p className="text-sm">נדרש לבוש צנוע והולם בעת ביקור באתרים דתיים ובמקומות ציבוריים.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">נעליים</p>
                <p className="text-sm">יש לנעול נעליים סגורות, כגון נעלי ספורט, במהלך הסיור.</p>
              </div>
              
              <div className="bg-white p-4 rounded-lg border border-red-100">
                <p className="font-semibold mb-2">ארוחות והפסקות</p>
                <p className="text-sm">אין עצירה מוגדרת לארוחת צהריים בטיול של מתחת לעשרה מטיילים, אך קיימת אפשרות להפסקה לקפה ומאפה בתוספת תשלום, במסגרת שעות הסיור.</p>
              </div>
            </div>
          </div>
        </div>
